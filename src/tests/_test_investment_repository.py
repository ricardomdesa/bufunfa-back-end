...
lista_invest_mock = [Investment('teste', 'xp', 'TEST3.SA', 20.0, 100).format_as_dict(),
...
def test_get_investments_by_username():
    ...
    assert {'username': 'teste',
            ...
            'rendimento': None, } == investments[0].format_as_dict()
...
def test_update_all_by_username():
    ...
    assert {'username': 'teste',
            ...
            'valor_investido_atual': None,
            'rendimento': None, } == investment[0].format_as_dict()
